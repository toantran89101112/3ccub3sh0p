...
window.conApp = {}, ! function(t) {
    ...
    i.DEFAULTS = {
        ...
        }), i.$yay.hasClass("yay-gestures") && i.useGestures(), i.$window.on("resize", function() {
            i.windowResize()
        ...
        var t = this;
        t.$body.removeClass("yay-hide"), setTimeout(function() {
        ...
        }), t.$window.on("touchend", function(o) {
            if (i) {
                var s = n - e,
                    a = t.$html.hasClass("rtl");
                if (i = 0, Math.abs(s) < 100) return;
                a && (s *= -1, n = t.$window.width() - n), 0 > s ? 40 > n && t.showYay() : t.hideYay()
            }
        })
    };
    var n;
    ...
    i.DEFAULTS = {
        ...
        t.simpleWeather({
            ...
            error: function(t) {
                e.$element.html("<h4>Error</h4><p>" + t + "</p>")
            }
        })
    ...
    var n = function(i, n) {
        this.options = n, this.$card = t(i), this.$closeBtn = this.$card.find("> .title > .close"), this.$minimizeBtn = this.$card.find("> .title > .minimize"), this.$content = this.$card.find("> .content")
    };
    n.DEFAULTS = {
        duration: 300
        ...
        var t = this;
        t.$content.hasClass("velocity-animating") || (t.$card.hasClass("minimized") ? t.$content.css("display", "none").velocity("slideDown", "swing", t.options.duration, i) : t.$content.css("display", "block").velocity("slideUp", "swing", t.options.duration, i), t.$card.toggleClass("minimized"))
    }, conApp.initCards = function() {
        t(".card").each(function() {
            var i = t.extend({}, n.DEFAULTS, t(this).data(), "object" == typeof option && option),
                e = new n(this, i);
            e.init()
        })
    ...
    n.DEFAULTS = {
    ...
    }, n.prototype.calculateStartStyles = function(i) {
        var n = this,
            e = n.$layer;
        this.isOpened || e.css({
            visibility: "hidden",
        ...
        var o = {
            ...
            width: e.width(),
            height: "fixed" == e.css("position") ? t(window).height() : e.height()
        };
        this.isOpened || e.css({
            display: "none",
            visibility: "visible"
        ...
        }, n.startStyles.left < 0 && (n.startStyles.left = 0), n.startStyles.top < 0 && (n.startStyles.top = 0), t.extend(n.startStyles, {
    ...
    var i, n, e, o = function(i) {
        ...
        s = function() {
            function t(t) {
                t ? o.pos.y = n + Math.random() * n * .2 : o.pos.y = n + 20, o.pos.x = Math.random() * i, o.scale = .1 + .7 * Math.random(), o.velocity = .5 * Math.random(), o.alpha = .1 + .2 * Math.random()
            }
            var o = this;
            o.pos = {}, this.draw = function() {
                o.alpha <= 0 && t(), o.pos.y -= o.velocity, o.alpha -= 4e-4, e.beginPath(), e.arc(o.pos.x, o.pos.y, 10 * o.scale, 0, 2 * Math.PI, !1), e.fillStyle = "rgba(32, 94, 145," + o.alpha + ")", e.fill()
            }, t(!0)
        };
    ...
    "undefined" != typeof $.fn.material_select && $("select:not(.select2, .disabled)").each(function() {
        var t = $(this).parent("label");
        $(this).material_select(), t.length && (t.wrap('<span style="color: #9e9e9e">'), $(this).parent().unwrap())
    }), "undefined" != typeof $.fn.slider && $(".slider").slider({
        full_width: !0
    ...
    if ("undefined" != typeof $.fn.tagsInput && $(".input-tag").tagsInput({
            width: "100%",
            height: "auto"
    ...
    "undefined" == typeof conAngular && (conApp.initSearchBar(), conApp.initPlugins(), conApp.initMaterialPlugins()), t(window).on("resize", function() {
        if ("undefined" != typeof nv && "undefined" != typeof nv.graphs && nv.graphs.length)
